...
labeling:
  ...
  tp_atr_mult: 2.4                 # symmetric (UNCHANGED from v2.59; DR-009 paused linear-ATR ladder)
...
| Path D fourth — alt calibration | **v2.62 (DR-010)** | **2.4** | **0.275% BTC / 0.60% SOL+LINK** | **12** | (BTC unchanged) | (BTC unchanged) | **Active for SOL+LINK; BTC frozen at v2.61 PASS** |
| Fallback if v2.62 alt distrib breaks | DR-011 candidate | 2.4 | adjust SOL min_profit_pct OR alt floor | 12 | — | — | Not triggered yet |
| Linear ATR escalation (BTC retune if regression) | DR-012 candidate | 2.3 | (asset-specific) | 12 | — | — | Not triggered yet |
