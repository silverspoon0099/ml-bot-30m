...
labeling:
  ...
  min_atr_pct_threshold:           # CHOP FILTER (per DR-007 / Decision v2.56)
    BTC: 0.275                     # DR-009: 0.25→0.275 per Decision v2.61 (incremental tighten; +0.025pp)
...
| Path D third — STRUCTURAL | **v2.61 (DR-009)** | **2.4** | **0.275%** | **12 (6hr)** | TBD | TBD | Active |
| Fallback if v2.61 misses | DR-010 candidate | 2.3 | 0.30% | 12 | — | — | Not triggered yet |
| Conservative floor | DR-010 candidate | 2.2 | 0.30% | 12 | — | — | Not triggered yet |
