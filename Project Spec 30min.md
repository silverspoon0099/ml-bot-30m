...
**Keep:**
- `prev_bar_close_vs_close_pct` — prev-bar close relative to current close as % (1)
- `prev_bar_high_vs_close_pct` — prev-bar high relative to current close as % (1)
- `prev_bar_low_vs_close_pct` — prev-bar low relative to current close as % (1)
- `prev_bar_volume_ratio` — prev-bar volume / current-bar volume (1)
- `today_open_to_now_pct` — % change from today's UTC-day open to current close (1)
- `today_high_low_distance_from_current_pct` — distance from today's running high or low to current close, whichever closer, as % (1)

**Drop (per Decision v2.37):**
